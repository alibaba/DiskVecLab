...
Setting::Setting(const char *index_path_hercules, const char *index_path_hnsw, unsigned int timeseries_size,
                 ...
                 int efConstruction, int M, const char *split_path) {
...
void Setting::toString(){
    ...
    this->buffered_memory_size << " | M : "<< this->M<< " | efConstruction : "<< this->efconstruction
    << " | split_path : " << this->split_path << std::endl;
}