...
namespace diskann {
  ...
  inline void load_bin(const std::string& bin_file, T*& data, size_t& npts,
    ...
    try {
      ...
      //diskann::cout << "Data contents: " << bin_file << std::endl;
      //for (size_t i = 0; i < 2; ++i) {
      //  for (size_t j = 0; j < dim; ++j) {
      //    diskann::cout << data[i * dim + j] << " ";
      //  }
      //  diskann::cout << std::endl;
      //}
      //diskann::cout << "End of data contents." << std::endl;
  ...
  inline uint64_t save_bin(const std::string& filename, T* data, size_t npts,
    ...
    //diskann::cout << "Data contents: " << filename << std::endl;
    //for (size_t i = 0; i < 2; ++i) {
    //  for (size_t j = 0; j < ndims; ++j) {
    //    diskann::cout << data[i * ndims + j] << " ";
    //  }
    //  diskann::cout << std::endl;
    //}
    //diskann::cout << "End of data contents." << std::endl;
