...
DistanceComputer* LLocalSearchQuantizer::preprocess_query(float* x) {
...
void LLocalSearchQuantizer::load_pq_compressed_vectors(const std::string &bin_file, uint8_t* &data, const std::string& data_type) {
    // TODO
