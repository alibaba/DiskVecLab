...
DefineQuantizerType(RaBitQ, std::shared_ptr<SPTAG::COMMON::RaBitQQuantizer>)
DefineQuantizerType(LSQ, std::shared_ptr<SPTAG::COMMON::LSQQuantizer>)
DefineQuantizerType(Flat, std::shared_ptr<SPTAG::COMMON::FlatQuantizer>)
