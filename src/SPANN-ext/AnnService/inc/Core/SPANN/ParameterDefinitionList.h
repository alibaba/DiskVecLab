...
DefineBasicParameter(m_fullVectorType, SPTAG::VectorFileType, SPTAG::VectorFileType::DEFAULT, "FullVectorType")
...
DefineSSDParameter(m_enableOutputDataSplit, bool, false, "enableOutputDataSplit")
DefineSSDParameter(m_splitDirectory, std::string, std::string("SPLIT"), "splitDirectory")
