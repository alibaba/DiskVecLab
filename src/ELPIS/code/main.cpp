...
int main(int argc, char **argv) {
    ...
    while (1) {
        static struct option long_options[] = {
                ...
                {"flatt",          required_argument, 0, 'F'},
                {"Lb",          required_argument, 0, 'L'},
                {"L",          required_argument, 0, 'N'},
                ...
                {"nworker",          required_argument, 0, 'W'},

                {"incremental",      no_argument,       0, 'h'},
                {"index-path-hercules",       required_argument, 0, 'D'},
                {"index-path-hnsw",       required_argument, 0, 'H'},
                {"help",             no_argument,       0, '?'}
        };
    ...
    cerr << "[Index Building Time] "<< index->time_stats->index_building_time<<"(sec)"<<endl;
        ...
        Index * index = Index::Read(index_path,mode,split_path);
